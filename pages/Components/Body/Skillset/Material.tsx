...
const Material: React.FC<MaterialProps> = () => {
  useEffect(() => {
    ...
    const fadeElms = document.querySelectorAll(".skills_material_grid");
  ...
  return (
    <Grid
      ...
      xl={2}
      justify="center"
      className="skills_material_grid fadeOutSkills"
    >
        ...
        <Paper variant="outlined" className="skills_paper">
          ...
          >
            <Grid container justify="center" item xs={4} sm={12} xl={12}>
              <img
                src={"https://i.imgur.com/XS3WnKo.png"}
                className="skills_icon_typescript"
              />
            </Grid>
            <Grid container justify="center" item xs={8} sm={12} xl={12}>
              <Typography className="skills_name">Material UI</Typography>
              <Typography className="skills_description">
                Material Library, Material Design and Icons!
              </Typography>
            </Grid>
          </Grid>
        </Paper>
