...
const Redux: React.FC<ReduxProps> = () => {
  useEffect(() => {
    ...
    const fadeElms = document.querySelectorAll(".skills_redux_grid");
  ...
  return (
    <Grid
      ...
      xl={2}
      justify="center"
      className="skills_redux_grid fadeOutSkills"
    >
